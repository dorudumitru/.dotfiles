...
-- === Wayscriber ===
hl.bind("SUPER + W", hl.dsp.exec_cmd("wayscriber --daemon-toggle"))
...
hl.bind("CTRL + Print", hl.dsp.exec_cmd("dms screenshot --dir ~/Photos"))
hl.bind("ALT + Print", hl.dsp.exec_cmd("dms screenshot window --dir ~/Photos"))
